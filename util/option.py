...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='total-text', type=str, choices=['synth-text', 'total-text', 'custom'], help='Dataset name (use "custom" for your own PNG+txt data)')
        self.parser.add_argument('--data_root', default=None, type=str, help='Root directory for custom dataset (must contain images/ and labels/)')
        ...
        self.parser.add_argument('--save_dir', default='newlogs/save/', help='Path to save checkpoint models')
        self.parser.add_argument('--vis_dir', default='newlogs/vis/', help='Path to save visualization images')
        self.parser.add_argument('--log_dir', default='newlogs/logs/', help='Path to tensorboard log')
        ...
        self.parser.add_argument('--max_epoch', default=600, type=int, help='Max epochs')
        ...
        self.parser.add_argument('--stepvalues', default=[5000], nargs='+', type=int, help='# of iter to change lr')
        self.parser.add_argument('--weight_decay', '--wd', default=0.0001, type=float, help='Weight decay for SGD')
        ...
        self.parser.add_argument('--val_freq', default=150, type=int, help='do validation every # iterations')
        ...
        self.parser.add_argument('--input_size', default=768, type=int, help='model input size')  ## should be divisible by 32
